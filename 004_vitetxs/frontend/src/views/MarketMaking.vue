    ...
    onSubmit: async function () {
      ...
      try {
        ...
        const response = await axios.post(
          process.env.VUE_APP_API_URL + "mining/marketmaking/",
          params
        );
        ...
        link.href = url;
        link.setAttribute("download", "marketMaking_" + viteAddress.trim() + ".csv"); //or any other extension
